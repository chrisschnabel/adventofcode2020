...
class Group_Declaration:
    ...
    def __init__(self, input_list):
        ...
        self.anyone_declaration = set()
        self.everyone_declaration = set()
        self.group_sum = 0


        for x in input_list:
            self.anyone_declaration.update(x)
            self.everyone_declaration = self.everyone_declaration.union(x)
    ...
    def get_everyone_yes_sum(self):
        return len(self.everyone_declaration)
